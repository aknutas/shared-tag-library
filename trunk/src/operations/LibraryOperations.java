...
public abstract class LibraryOperations {
    ...
    /**
     * Returns an iterator over all of the tags on all of the books on all of
     * the shelfs in the given library.
     */
	...
	while (master.hasNext()) {
		...
		// System.out.println("Tagging: " + tag.getKey() + " : " +
		// tag.getValue());
    ...
    /**
     * Returns an iterator over all of the properties on all of the books on all
     * of the shelfs in the given library.
     */
