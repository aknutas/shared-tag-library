...
public class RemoteBook extends RemoteObject implements Book {
    ...
    /**
     * Creates a RemoteBook object given the network, connection, and id.
     * 
     * @param connection
     ...
     * @param id
     *            the id to use in for the RoutedMessages
     * 
     * @throws NullPointerException
     *             if the network given is null
     * @throws RemoteObjectException
     *             if the RemoteBook object cannot be created
     */
    public RemoteBook(Control network, int connection, int id)
    ...
    /**
     * This method sends a MSG_INITIALIZE message to the responder in order to
     * get the tags and properties from a book and cache them locally.
     * 
     * @throws RemoteObjectException
     *             if there was an error receiving the properties or tags
     */
    @SuppressWarnings("unchecked")
    private void getBookInfo() throws RemoteObjectException {
	RemoteMessage message = new BookMessage(BookMessage.MSG_INITIALIZE,
		this.id);
	...
	Map<String, Integer> tags = (Map<String, Integer>) message
		.dequeParameter();
	Map<String, String> properties = (Map<String, String>) message
		.dequeParameter();
