...
public class PersistentLibrary extends VirtualLibrary {
    ...
    /**
     * Creates a new PersistentLibrary object using the given QueryBuilder
     * object to access the database layer.
     * 
     * @param database
     *            the QueryBuilder to use
     * 
     * @throws NullPointerException
     *             if the database given is null
     */
	...
	Object obj = ProgramProperties.getInstance().getProperty(
		"data::library_properties");
    ...
    /**
     * Saves a bookshelf to the persistent storage and adds the shelf to the
     * library.
     * 
     * @param shelf
     *            the shelf to save to the library.
     * 
     * @return true if the shelf was successfully saved, otherwise false
     * 
     * @throws NullPointerException
     *             if the shelf given is null
     */
    public boolean saveBookshelf(VirtualBookshelf shelf)
	    throws NullPointerException {
	if (null == shelf)
    ...
    /**
     * Deletes a bookshelf from the persistent storage and removes the shelf
     * from the library.
     * 
     * @param shelf
     *            the shelf to delete from the library.
     * 
     ...
     *             if the shelf given is null
     */
    public boolean deleteBookshelf(VirtualBookshelf shelf)
	    throws NullPointerException {
	if (null == shelf)
	    throw new NullPointerException("shelf cannot be null");
    ...
    /**
     * Determines whether the given VirtualBookshelf is stored in this
     * persistent library.
     * 
     * @param shelf
     *            the shelf to check
     ...
     *             if the shelf given is null
     */
    public boolean shelfStored(VirtualBookshelf shelf)
	    throws NullPointerException {
	if (null == shelf)
	    throw new NullPointerException("shelf cannot be null");
