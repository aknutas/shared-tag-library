...
public class RemoteBookIterator extends RemoteIterator<Book> {
	...
	/**
	 * Creates a new RemotebookIterator with the given network,
	 * connection and id.
	 * 
	 * @param network the network Control object to use
	 * @param connection the connection id to talk over
	 * @param id the RoutedMessage id to use
	 *  
	 * @throws NullPointerException if the network given is null
	 * @throws RemoteObjectException if the RemoteObjectCould not be
	 *         created
	 */
	...
	/**
	 * Deserializes the first parameter of an IteratorMessage into a
	 * Book object.
	 * 
	 * @param message the message to Deserialize
	 * 
	 * @return the Book message that was deserialized, or null if if
	 *         there was an error
	 *         
	 * @throws NullPointerException if the message given is null
	 * @throws IllegalArgumentException if the message given is not
	 *         of the type MSG_MORE
	 */
	@Override
