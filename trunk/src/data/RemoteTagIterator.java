...
public class RemoteTagIterator extends RemoteIterator<Entry<String, Integer>> {
    ...
    /**
     * Creates a new RemoteTagIterator from the given network, connection and
     * id.
     * 
     * @param network
     ...
     */
    public RemoteTagIterator(Control network, int connection, int id)
     ...
     */
    @Override
    public Entry<String, Integer> createObject(IteratorMessage message)
	    throws NullPointerException {
	if (null == message)
