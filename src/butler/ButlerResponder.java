...
/**
 * The ButlerResponder class extends the RemoteResponder and is used to
 * respond to RemoteMessages from RemoteLibraryButler objects over a network.
 * It generates its response based on the HeadButler object it contains.
 * 
 * @author sjpurol
 */
public class ButlerResponder extends RemoteResponder {
	...
	/**
	 * Creates a new instance of ButlerResponder that passes information from butler over the network.
	 * @param butler the butler that this responder represents.
	 * @throws IllegalArgumentException if butler is null.
	 */
	...
	/**
	 * Responds to a request to initialize a RemoteLibraryButler by queuing
	 * the ButlerWeights of each VirtualLibraryButler within the HeadButler.
