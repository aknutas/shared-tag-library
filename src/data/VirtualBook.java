...
public class VirtualBook implements Book, Serializable {
     ...
     *             if the author or title given are null.
     */
    public VirtualBook(String title, String author)
	    throws IllegalArgumentException {
    ...
    /**
     * Creates a VirtualBook object from the given Map of tags and properties.
     * This is a protected method and is used only inside this package.
     * 
     * @param tags
     *            the tags Map to use
     * @param properties
     *            the properties Map to use
     * 
     * @throws NullPointerException
     *             if the tags or properties given are null.
     */
    protected VirtualBook(Map<String, Integer> tags,
	    Map<String, String> properties) throws NullPointerException {
    ...
    /**
     * Returns an iterator containing all the of a book and their given weights.
     * 
    ...
    /**
     * Get the number of tags that are associated with this Book object.
     * 
    ...
    /**
     * An overridden equals method. This is used to compare two book objects to
     * each other.
     * 
     * @param object
	...
	for (Entry<String, String> property : book.enumerateProperties()) {
	    ...
	    if (!property.getValue().equals(
		    this.properties.get(property.getKey())))
		return false;
	}
    ...
    /**
     * Returns a VirtualBook object of this Book interface object. If the book
     * is already a VirtualBook then the Book is returned and no copy is made.
     * 
