...
public abstract class RemoteResponder implements ServerResponder {
     ...
     * RemoteResponder does not handle (not ping). This method should return a
     * RemoteMessage object to send back to the client.
     * 
     * @param message
     ...
     */
    public abstract RemoteMessage onRemoteMessage(RemoteMessage message)
	    throws NullPointerException, IllegalArgumentException;

    /**
     * This method is used to handle RemoteMessages for which the extending
     * class cannot handle.
     * 
     * @param message
     ...
     *             if the message given is null
     * @throws IllegalArgumentException
     *             if the message given is not a RemoteMessage
     */
    @Override
    public Message onMessage(Message message) throws NullPointerException,
