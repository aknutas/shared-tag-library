...
public class RemoteBookshelfIterator extends RemoteIterator<Bookshelf> {
    ...
    /**
     * Creates a new RemoteLibraryIterator with the given network control,
     * connection, and id.
     * 
     * @param network
     ...
     *             if the object cannot establish a connection
     */
    public RemoteBookshelfIterator(Control network, int connection, int id)
	    throws NullPointerException, RemoteObjectException {
	super(network, connection, id);
    }

    /**
     * Creates a RemoteBookshelf object from object given. The object is
     * expected to be an Integer representing the ID of the BookshelfResponder
     ...
     *             if the parameter type canont be handled by this function
     */
    @Override
    public Bookshelf createObject(IteratorMessage message)
