 ...
 * Book object. It is used to iterate over all the books matching the comparable
 * object object given, or all books if the comparable given is null.
 * 
 * @author Andrew Alm
 */
public class VirtualBookshelfIterator implements Iterator<Book> {
    ...
    /**
     * Creates a new VirtualBookshelfIterator with the given books, bookshelves
     * and comparable to use to iterator over.
     * 
     * @param books
     *            the books to iterate over
     * @param bookshelves
     *            the bookshelves to iterate
     * @param comparable
     *            used to check if a book should actually exist in this Iterator
     * 
     * @throws NullPointerException
     *             if the books or bookshelves given are null
     */
    public VirtualBookshelfIterator(Iterable<Book> books,
	    Iterable<Bookshelf> bookshelves, Comparable<Book> comparable)
	    throws NullPointerException {
	if ((null == books) || (null == bookshelves))
	    throw new NullPointerException(
		    "books or bookshelves cannot be null");
    ...
    /**
     * This method is used to determine if the iterator has any more data
     * available.
     * 
