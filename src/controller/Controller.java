...
public class Controller {
    ...
    /**
     * Method for reinitializing or setting up a set of connections
     * if no stored connections it creates an empty set
     * @param props
     * @throws UnknownHostException
     * @throws IllegalArgumentException
     * @throws NullPointerException
	...
	if (host != null) {
		...
		System.err.println("connection error with "+ host + " reason "+ e);
		e.printStackTrace();
	    } 
	}
    }
